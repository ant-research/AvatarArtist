...
class LPIPS(nn.Module):
    def __init__(self, vgg_path, pretrained=True, net='alex', version='0.1', lpips=True, spatial=False,
        ...
        self.net = net_type(path=vgg_path, pretrained=not self.pnet_rand, requires_grad=self.pnet_tune)
